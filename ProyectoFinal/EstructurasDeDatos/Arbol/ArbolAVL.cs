...

{
    public class ArbolAVL
    {
        ...
        public NodoAvl buscar(Object buscado)
        {
            Comparador dato = (Comparador)buscado;
            return buscar(raiz, dato);
        }

        protected NodoAvl buscar(NodoAvl raizSub, Comparador buscado)
        {
            if (raizSub == null)
            {
                return null;
            ...
            {
                // Conversión explícita a NodoAvl
                return buscar((NodoAvl)raizSub.subarbolIzdo(), buscado);
            }
            else
            {
                // Conversión explícita a NodoAvl
                return buscar((NodoAvl)raizSub.subarbolDcho(), buscado);
            }
        }

        public NodoAvl buscarIterativo(Object buscado)
        {
            Comparador dato = (Comparador)buscado;
            ...
            while (raizSub != null)
            {
                ...
                {
                    // Conversión explícita a NodoAvl
                    raizSub = (NodoAvl)raizSub.subarbolIzdo();
                }
                else
                {
                    // Conversión explícita a NodoAvl
                    raizSub = (NodoAvl)raizSub.subarbolDcho();
                }
            }
        ...
        public void modificar(Object valorOriginal, Object valorModificado)
        {
            eliminar(valorOriginal);
            insertar(valorModificado);
        }
